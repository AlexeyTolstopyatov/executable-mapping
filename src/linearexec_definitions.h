 ...
 */
#define __LE_NUL 0x00 /* Неизвестная (новая) ОС */
#define __LE_WIN 0x02 /* MS-Windows */
#define __LE_OS2 0x01 /* IBM OS/2 */
#define __LE_DOS 0x03 /* MS-DOS 4x */
#define __LE_386 0x04 /* MS-Windows с поддержкой расширений 386 */
...
#define __LE_CPU_R20 0x40 /* MIPS R2000 микропроцессор */
